...
<div style="margin:0 auto;font-size:1.05em; font-family: 'Open Sans', sans-serif;">
    ...
    <p style="text-align: center; font-size: 35px; background-color: #2153C1; padding: 0px 80px; color: white">ATTESTATION INDIVIDUELLE DE FIN DE FORMATION</p>
    <div style="text-align: justify !important;">
        ...
        <p style='margin-left: 30px; font-size:16px;'><span style="text-decoration: underline">Durée du Bilan de compétences</span> : 24h00</p>
    ...
    {{--    <div style="text-align:center; font-size: 10px; position: absolute; bottom: 5px; left: 50%; transform: translate(-50%, -50%)">--}}
    {{--        {!! nl2br($pied_page) !!}--}}
    {{--    </div>--}}
