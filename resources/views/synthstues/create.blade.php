                        ...
                        <div class="card-body">
                            <div class="col-lg-12">
                                <div class="info-box ">
                                    ...
                                    <h3>Ajouter Un Nouvel Expert</h3>
                                    <p>Enovyer un mail,<br>Et créer sa synthèse</p>
                                </div>
                                <button type="button" class="btn btn-lg btn-primary" data-bs-toggle="modal" data-bs-target="#largeModal"> + Ajouter Un Nouvel Expert </button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-md-12">
                    <form action="/init_tue" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Identifiant de l'expert</h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Mot de passe de l'expert </h5>
                        ...
                        <div class="col-md-12">
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                ...
                                <br>
                                <div class="row">
                                    <input id="datepicker" name="dates" required/>
                                    <script>
                        ...
                        <div class="card">
                            <a id="link_mail" onclick="call_expert()" class="btn btn-block btn-primary">ENVOYER UN MAIL POUR SIGNALER </a><br>
...
<script type="text/javascript">
    ...
    function getContent() {
        ...
        xhr.open('GET', '{{ route('search_tue') }}/?search=' + searchValue, true);
...
<script>
    var intervalId = window.setInterval(function() {
        if ((document.getElementById("surname").value.length) > 2 && (document.getElementById("name").value.length) > 2) {
            document.getElementById("password").value = "Expert123456";
        }
