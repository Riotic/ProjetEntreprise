        ...
        <div class="square">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <form action="{{ route('synthstucs.update', $synthstuc->id) }}" method="POST" enctype="multipart/form-data">
                                {{ method_field('PUT') }}
                                @csrf
                            <!-- Recent Activity -->
                            <div class="card">
                              <div class="card-body">
                                <h5 class="card-title">Modifier la Synthèse <span>| {{$synthstuc->nom}}</span></h5>

                                <h5>Photo de profil JPG/PNG</h5>
                                <p>Veuillez mettre une photo de 200x200 en dessous de 2000ko/2Mo s'il vous plaît</p>
                                <div class="child">
                                    <img src="" alt="product {{$synthstuc->photoProfil}} picture"><br>
                                </div>
                                <input class="form-control" type="file" placeholder="Photo de profil" value="{{$synthstuc->photoProfil}}" name="photoProfil"><br>
                                <h5>CV en pdf</h5>
                                <input class="form-control" type="file" placeholder="CV" value="{{$synthstuc->CV}}" name="CV"><br>

                                <h5 class="card-title">Metier</span></h5>
                                <input class="form-control" type="text" placeholder="Metier" value="{{$synthstuc->metier}}" name="metier"><br>
                                ...
                                <input class="form-control" type="text" placeholder="Adresse" value="{{$synthstuc->adresse}}" name="adresse"><br>
                                <h5 class="card-title">Telephone</span></h5>
                                <small>Exemple: 06 41 89 43 01</small><br>
                                <input class="form-control" type="tel" placeholder="Telephone" value="{{$synthstuc->telephone}}" pattern="[0]{1}[0-9]{1} [0-9]{2} [0-9]{2} [0-9]{2} [0-9]{2}" name="telephone" title="Ecrivez le numéro de téléphone en respectant le format qui vous est indiqué"><br>

                                <h5 class="card-title">Email</span></h5>
                                <input class="form-control" type="email" placeholder="Email" value="{{$synthstuc->email}}" name="email"><br>
                                <h5 class="card-title">Website</span></h5>
                                <small>Format:http(s)://..../</small><br>
                                <input class="form-control" type="text" placeholder="Website" value="{{$synthstuc->website}}" pattern="https?://.+/" name="website" title="Ecrivez le site sous format http(s) avec un / à la fin comme indiqué si dessus"><br>
				<h5 class="card-title">instagram</span></h5>
                                <input class="form-control" type="text" placeholder="instagram" value="{{$synthstuc->instagram}}" pattern="https?://.+/" name="instagram" title="Ecrivez le site sous format http(s) avec un / à la fin comme indiqué si dessus"><br>
                                <h5 class="card-title">twitter</span></h5>
                                <input class="form-control" type="text" placeholder="twitter" value="{{$synthstuc->twitter}}" pattern="https?://.+/" name="twitter" title="Ecrivez le site sous format http(s) avec un / à la fin comme indiqué si dessus"><br>
                                <h5 class="card-title">facebook</span></h5>
                                <input class="form-control" type="text" placeholder="facebook" value="{{$synthstuc->facebook}}" pattern="https?://.+/" name="facebook" title="Ecrivez le site sous format http(s) avec un / à la fin comme indiqué si dessus"><br>
                                <h5 class="card-title">Linkedin</span></h5>
                                <input class="form-control" type="text" placeholder="Linkedin" value="{{$synthstuc->linkedin}}" pattern="https?://.+/" name="linkedin" title="Ecrivez le site sous format http(s) avec un / à la fin comme indiqué si dessus"><br>
                                <h5 class="card-title">Autre réseau social</span></h5>
                                <input class="form-control" type="text" placeholder="Autre réseau social" value="{{$synthstuc->reseau_autre}}" pattern="https?://.+/" name="reseau_autre" title="Ecrivez le site sous format http(s) avec un / à la fin comme indiqué si dessus"><br>
                                ...
                                <textarea hidden class="form-control" type="text" id="all_Exp" placeholder="Experiences" value="" name="experiences">{{$synthstuc->experiences}}</textarea><br>
                                ...
                                <textarea hidden class="form-control" type="text" id="all_For" placeholder="Formations" value="" name="formations">{{$synthstuc->formations}}</textarea><br>
				...
				<input class="form-control" type="text" hidden name="departement" id="changeDep" value="{{$synthstuc->departement}}" >
                                <input class="form-control" type="text" disabled value="Departement actuel : {{$synthstuc->departement}}"><br>
				<div class="card">
                                    <div class="card-body">
                                        ...
                                        <select onclick="checkIfSelectClicked()" class="form-control" id="departement" value="{{$synthstuc->departement}}" >
                                ...
                                <div class="card">
                                    ...
                                    <div class="d-grid gap-2 mt-3">
                                        <button class="btn btn-success" name="action" type="submit" value="edit">MODIFIER</button>
                          ...
                          <div class="card">
                            ...
                            <section class="profile">
                              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                  ...
                                  <p class="small fst-italic"><?php echo $synthstuc->nom; ?></p>
