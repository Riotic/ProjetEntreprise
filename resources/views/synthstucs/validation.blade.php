...
<div class="main_div contact">
    ...
    @endif
    @php
    //$synthstucss = DB::SELECT("SELECT * FROM `synthstucs` where email='".Auth::user()->email."'");
    $synthstucss = DB::SELECT("SELECT * FROM `synthstucs` where  client_id='".Auth::user()->id."'");
    ...
    @endphp
    @foreach ($synthstucss as $synthstucs)
    <div class="row">
                ...
                <div class="col-xl-6">
                    ...
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            @if ( $synthstucs->photoProfil == "none")
                            ...
                            @else
                            <img src="../syn/public/TuC_profil_pictures/{{$synthstucs->photoProfil}}" alt="Profile"  height="100" width="100" class="rounded-circle">
                            @endif
                            <h2>{{$synthstucs->nom}} {{$synthstucs->prenom}}</h2>
                            <h3>{{$synthstucs->metier}} </h3>
                            <div class="social-links mt-2">
                                <a href="{{$synthstucs->website}}" class="globe"><i class="bi bi-globe"></i></a>
                                <a href="{{$synthstucs->reseau_autre}}" class="youtube"><i class="bi bi-youtube"></i></a>
                                <a href="{{$synthstucs->linkedin}}" class="linkedin"><i class="bi bi-linkedin"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Experiences </span></h5>
                                ...
                                Carbon\Carbon::setLocale('fr');
                                    $experiences = $synthstucs->experiences;
                                    $experiences = json_decode(($experiences),  true);
                                    $formations = $synthstucs->formations;
                                ...
                                <table class="table responsive table-responsive">
                                  ...
                                  <tbody>
                                    @if (isset($synthstucs->experiences))
                                ...
                                <table class="table responsive table-responsive">
                                  ...
                                  <tbody>
                                    @if (isset($synthstucs->formations))
                            ...
                            <div class=" pt-2">
                                ...
                                <div class="tab-pane profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8">{{$synthstucs->nom}} {{$synthstucs->prenom}}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Website</div>
                                        <div class="col-lg-9 col-md-8">{{$synthstucs->website}}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Linkedin</div>
                                        <div class="col-lg-9 col-md-8">{{$synthstucs->linkedin}}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Metier</div>
                                        <div class="col-lg-9 col-md-8">{{$synthstucs->metier}}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Address</div>
                                        <div class="col-lg-9 col-md-8">{{$synthstucs->adresse}}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">departement</div>
                                        <div class="col-lg-9 col-md-8">{{$synthstucs->departement}}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Phone</div>
                                        <div class="col-lg-9 col-md-8">{{$synthstucs->telephone}}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Email</div>
                                        <div class="col-lg-9 col-md-8">{{$synthstucs->email}}</div>
                                    </div>
                                    <div class="row">
                                        @if ( $synthstucs->CV == "none")
		                            ...
		                            <embed src="../syn/public/TuC_CV/{{ $synthstucs->CV }}" width="300" height="375" type="application/pdf">
                                            @endif
                                    </div>
                                </div>
            ...
            <div class="modal-body">
                <div class="col-md-12">
                    <form action="/valid" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="id_synthstucs" value="{{$synthstucs->id}}">
                        <div class="card">
                            <div class="card-body">
                                <p class="text-center">
