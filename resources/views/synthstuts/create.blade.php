                        ...
                        <div class="card-body">
                            <div class="col-lg-12">
                                <div class="info-box ">
                                    ...
                                    <h3>Ajouter Un Nouveau Thérapeute</h3>
                                    <p>Enovyer un mail,<br>Et créer sa synthèse</p>
                                </div>
                                <button type="button" class="btn btn-lg btn-primary" data-bs-toggle="modal" data-bs-target="#largeModal"> + Ajouter Un Nouveau thérapeute </button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-md-12">
                    <form action="/init_tut" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Identifiant du therapeute</h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Mot de passe du therapeute </h5>
                        ...
                        <div class="card">
                            <a id="link_mail" onclick="call_therapeute()" class="btn btn-block btn-primary">ENVOYER UN MAIL POUR SIGNALER </a>
                            <br>
			    <button id="button_register" style=""   type="submit" class="btn btn-block btn-success" disabled>SAUVEGARDER </button>
                        </div>
...
<script type="text/javascript">
    ...
    function getContent() {
        ...
        xhr.open('GET', '{{ route('search_tut') }}/?search=' + searchValue, true);
...
<script>
    var intervalId = window.setInterval(function() {
        if ((document.getElementById("surname").value.length) > 2 && (document.getElementById("name").value.length) > 2) {
            document.getElementById("password").value = "therapie123456";
        }
        //setCookie('html', html, 30);
    }, 3000);
</script>
<script>
    function call_therapeute() {
    var content = "Synthèse Therapeute \nPour vous connecter sur la plateforme https://bdc-synthese.fr/ veuillez utiliser les logins suivants. \nEmail : " + document.getElementById("email").value + " \nMot de passe :  therapie123456 \nAprès divers entretiens avec votre formateur(rice) vous aurez vos identifiants et mot de passe pour vous connecter sur la plateforme trouver-un-therapeute.fr";


        var link = "mailto:" + document.getElementById("email").value
             + "?cc=contact@trouver-un-therapeute.fr"
